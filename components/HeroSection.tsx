      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-4xl mx-auto">
          ...
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold leading-tight mb-6">
            <span className="text-gray-900">فني صيانة</span>{" "}
            <span className="gradient-text">أجهزة منزلية</span>
            <br />
            <span className="text-gray-900">في أبها وخميس مشيط</span>
          </h1>
          ...
          <div className="flex flex-wrap items-center justify-center gap-4 mt-10 text-sm text-gray-500">
